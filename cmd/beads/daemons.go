...
var daemonsCmd = &cobra.Command{
	Use:   "daemons",
	Short: "Manage multiple beads daemons",
	Long: `Manage beads daemon processes across all repositories and worktrees.
...
var daemonsListCmd = &cobra.Command{
	Use:   "list",
	Short: "List all running beads daemons",
	Long: `List all running beads daemons with metadata including workspace path, PID, version,
...
var daemonsStopCmd = &cobra.Command{
	...
	Short: "Stop a specific beads daemon",
	Long: `Stop a specific beads daemon gracefully by workspace path or PID.
...
var daemonsRestartCmd = &cobra.Command{
	...
	Short: "Restart a specific beads daemon",
	Long: `Restart a specific beads daemon by workspace path or PID.
Stops the daemon gracefully, then starts a new one.`,
	Args: cobra.ExactArgs(1),
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Fprintf(os.Stderr, "Error: restart not yet implemented\n")
		fmt.Fprintf(os.Stderr, "Use 'beads daemons stop <target>' then 'beads daemon' to restart manually\n")
		os.Exit(1)
	},
}
...
var daemonsLogsCmd = &cobra.Command{
	...
	Short: "View logs for a specific beads daemon",
	Long: `View logs for a specific beads daemon by workspace path or PID.
...
var daemonsKillallCmd = &cobra.Command{
	Use:   "killall",
	Short: "Stop all running beads daemons",
	Long: `Stop all running beads daemons gracefully via RPC, falling back to SIGTERM/SIGKILL.
...
var daemonsHealthCmd = &cobra.Command{
	Use:   "health",
	Short: "Check health of all beads daemons",
	Long: `Check health of all running beads daemons and report any issues including
