...
import (
	...
	"github.com/shaneholloman/beads/internal/utils"
			...
			for idx, id := range resolvedIDs {
				...
				if jsonOutput {
					...
					if issue.CompactionLevel > 0 {
						...
						fmt.Printf("Compacted: %s (Tier %d)\n", compactedDate, issue.CompactionLevel)
					}
...
Examples:
  beads edit beads-42                    # Edit description
  beads edit beads-42 --title            # Edit title
  beads edit beads-42 --design           # Edit design notes
  beads edit beads-42 --notes            # Edit notes
  beads edit beads-42 --acceptance       # Edit acceptance criteria`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		tmpFile, err := os.CreateTemp("", fmt.Sprintf("beads-edit-%s-*.txt", fieldToEdit))
		if err != nil {
