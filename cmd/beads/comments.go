...
Examples:
  ...
  beads comments beads-123

  # List comments in JSON format
  beads comments beads-123 --json

  # Add a comment
  beads comments add beads-123 "This is a comment"

  # Add a comment from a file
  beads comments add beads-123 -f notes.txt`,
...
Examples:
  # Add a comment
  beads comments add beads-123 "Working on this now"
