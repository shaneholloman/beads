...
Example:
  beads rename-prefix kw-         # Rename from 'knowledge-work-' to 'kw-'
  beads rename-prefix mtg- --repair  # Consolidate multiple prefixes into 'mtg-'`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(prefixes) > 1 {
			...
			if !repair {
				...
				fmt.Fprintf(os.Stderr, "Example: beads rename-prefix %s --repair\n", newPrefix)
				os.Exit(1)
			}
